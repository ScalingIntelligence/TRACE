...
class VLLMUser(OpenAIAPIUser):
    """User simulator for any model served via vLLM (OpenAI-compatible API)."""
    model_name: str

    def __init__(self, model_name: str = "Qwen/Qwen3-30B-A3B-Instruct-2507") -> None:
        import os
        self.model_name = model_name
        base_url = os.environ.get("VLLM_USER_URL", os.environ.get("VLLM_BASE_URL", os.environ.get("OPENAI_BASE_URL", "http://localhost:8080/v1")))
