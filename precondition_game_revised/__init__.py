...
state-changing actions. Uses the EXACT same airline and retail tools, DB
format, policy, and system prompt as tau2-bench.
...
Supports both airline and retail domains with dynamic per-seed DB generation,
adversarial users for REFUSE scenarios, and progressive disclosure.
