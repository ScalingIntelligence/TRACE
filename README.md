...
- [`configs/capability_selection.yaml`](configs/capability_selection.yaml) — model, eval results, selection thresholds
- [`configs/environment_generation.yaml`](configs/environment_generation.yaml) — model, vLLM settings, rollout parameters
...
This produces files in `prompts/`:
