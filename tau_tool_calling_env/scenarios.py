...
def generate_scenario(seed: int, domain: Optional[str] = None) -> GeneratedScenario:
    ...
    scenario_type = rng.choices(
        ["explicit", "selection", "policy_gated", "multi_step", "info_communicate"],
        weights=[25, 20, 15, 30, 10],
    )[0]
    ...
    all_types = ["explicit", "selection", "policy_gated", "multi_step", "info_communicate"]
